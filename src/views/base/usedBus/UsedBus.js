      ...
      <CCol>
        <CCard>
          <CCardHeader style={{ display: 'flex', justifyContent: 'space-between' }}>
            <strong>Used Bus Data</strong>
            <CButton color="primary" href="/base/used-bus/add-bus">
              Add
            </CButton>
          </CCardHeader>
          <CCardBody>
            <CTable bordered>
              ...
              <CTableBody>
                <CTableRow>
                  ...
                  <CTableDataCell>
                    <CButton color="primary" href="/base/used-bus/view-bus" className="w-0">
                      <i data-eva="eye" fill="white" width="16px" height="16px" />
                    </CButton>
                    &nbsp;&nbsp;
                    <CButton color="warning" href="/base/used-bus/edit-bus" className="w-0">
